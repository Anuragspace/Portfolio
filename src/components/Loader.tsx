...
const StyledWrapper = styled.div`
  ...
  .loader .box {
    position: absolute;
    background: rgba(62, 64, 239, 0.15);
    background: var(--background);
    border-radius: 50%;
    border-top: 1px solid rgba(62, 64, 239, 1);
    box-shadow: rgba(62, 64, 239, 0.3) 0px 10px 10px -0px;
  ...
  .loader .box:nth-child(2) {
    inset: 30%;
    z-index: 98;
    border-color: rgba(62, 64, 239, 0.8);
  ...
  .loader .box:nth-child(3) {
    inset: 20%;
    z-index: 97;
    border-color: rgba(62, 64, 239, 0.6);
  ...
  @keyframes ripple {
    ...
    50% {
      transform: scale(1.3);
      box-shadow: rgba(62, 64, 239, 0.3) 0px 30px 20px -0px;
    }
    100% {
      transform: scale(1);
      box-shadow: rgba(62, 64, 239, 0.3) 0px 10px 10px -0px;
