...
export function SocialDock() {
  ...
  return (
    <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-50">
      <Dock direction="middle" className="px-3 py-2 bg-white border border-gray-200 rounded-xl shadow-lg">
        <DockIcon>
          <Button
            onClick={() => setTheme("dark")}
            variant="ghost"
            size="icon"
            className="w-10 h-10 text-black flex items-center justify-center hover:bg-gray-100 transition-colors"
