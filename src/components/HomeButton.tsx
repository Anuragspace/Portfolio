    ...
    const toggleVisibility = () => {
      ...
      if (window.scrollY > 300) { // Show earlier
        ...
        if (footerRef.current) {
          ...
          const hideThreshold = window.innerHeight - 200; // Larger margin from footer
    ...
    <AnimatePresence>
      {visible && (
        <motion.button
          ...
          onClick={scrollToTop}
          className="fixed left-6 bottom-12 z-50 flex items-center justify-center w-12 h-12 rounded-full bg-white dark:bg-gray-800 shadow-lg hover:shadow-xl transition-all duration-300 hover:bg-gray-100 dark:hover:bg-gray-700 border border-gray-200 dark:border-gray-700"
