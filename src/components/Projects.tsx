...
const Projects = () => {
  const projects: Project[] = [
    ...
    },
    {
      ...
      year: "2025",
      description: "Designed intuitive user flows, verification systems, structured assessment templates, and administration dashboards as a UI/UX Design Intern to optimize student engagement.",
      image: "/images/nexfellow/banner.png",
