...
const Skills = () => {
  ...
  return (
    <section id="skills" className="section-padding bg-gray-50 overflow-hidden" data-scroll-section>
      <div className="container-custom">
        ...
        <HorizontalScroll className="relative mb-12 py-6 overflow-hidden" speed={0.05}>
          {/* Gradient overlay left */}
          <div className="absolute left-0 top-0 h-full w-[15%] bg-gradient-to-r from-gray-50 to-transparent z-10"></div>
          
          {/* Scrolling content - no longer needs animate-marquee */}
          <div className="flex gap-6 whitespace-nowrap" style={{ minWidth: '200%' }}>
