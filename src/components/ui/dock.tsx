...
export function Dock({
  ...
  const justifyContent = direction === "left" ? "justify-start" : direction === "right" ? "justify-end" : "justify-center";
  ...
  return <DockContext.Provider value={{
    mouseX
      ...
      <motion.div ref={ref} onMouseMove={handleMouseMove} onMouseLeave={handleMouseLeave} className="">
        {children}
      </motion.div>
...
export function DockIcon({
  ...
  const {
    size
  } = useDockHoverAnimation(mouseX, ref);
