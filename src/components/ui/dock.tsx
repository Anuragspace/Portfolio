  ...
  return (
    <DockContext.Provider value={{ mouseX }}>
      <motion.div 
        ...
        className={cn(
          "flex h-12 items-center gap-1 rounded-xl bg-white backdrop-blur-sm px-2 py-1.5 sm:p-2 border border-gray-100 shadow-md z-50 hover:shadow-lg transition-shadow",
          justifyContent,
          className
        )}
      >
